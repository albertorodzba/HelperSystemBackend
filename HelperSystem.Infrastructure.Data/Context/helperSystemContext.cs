...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ActivityJob>(entity =>
            {
                ...
                entity.Property(e => e.IdActivityJob)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_activity_job");

                entity.Property(e => e.FkIdActivity)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_id_activity")
                    .HasDefaultValueSql("'NULL'");

                entity.Property(e => e.FkIdJob)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_id_job")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<ActivityRequested>(entity =>
            {
                ...
                entity.Property(e => e.IdActivityRequested)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_activity_requested");
                ...
                entity.Property(e => e.FkIdJobOffer)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("FK_id_job_offer")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<Applicant>(entity =>
            {
                ...
                entity.Property(e => e.BodyPiercing)
                    .HasColumnName("body_piercing")
                    .HasDefaultValueSql("'NULL'");
                ...
                entity.Property(e => e.FkEducationLevel)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_education_level")
                    .HasDefaultValueSql("'NULL'");

                entity.Property(e => e.FkIdGender)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_id_gender")
                    .HasDefaultValueSql("'NULL'");

                entity.Property(e => e.FkIdJobStatus)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_id_job_status")
                    .HasDefaultValueSql("'NULL'");

                entity.Property(e => e.FkIdMaritalStatus)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_id_marital_status")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<ApplicantActivity>(entity =>
            {
                ...
                entity.Property(e => e.IdApplicantActivity)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_applicant_activity");

                entity.Property(e => e.ActivityPreference)
                    .HasColumnType("int(11)")
                    .HasColumnName("activity_preference")
                    .HasDefaultValueSql("'NULL'");
                ...
                entity.Property(e => e.FkIdApplicant)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("FK_id_applicant")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<ApplicantAllergie>(entity =>
            {
                ...
                entity.Property(e => e.IdApplicantAllergie)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_applicant_allergie");

                entity.Property(e => e.FkIdAllergie)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("FK_id_allergie")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<ApplicantCondition>(entity =>
            {
                ...
                entity.Property(e => e.IdApplicantCondition)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_applicant_condition");
                ...
                entity.Property(e => e.FkIdPhysicalCondition)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_id_physical_condition")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<ApplicantDesiredJob>(entity =>
            {
                ...
                entity.Property(e => e.IdApplicantDesiredJob)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_applicant_desired_job");
            ...
            modelBuilder.Entity<ApplicantDisability>(entity =>
            {
                ...
                entity.Property(e => e.IdApplicantDisability)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_applicant_disability");
                ...
                entity.Property(e => e.FkIdDisability)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_id_disability")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<ApplicantLanguage>(entity =>
            {
                ...
                entity.Property(e => e.IdApplicantLanguage)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_applicant_language");
                ...
                entity.Property(e => e.FkIdLanguage)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_id_language")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<ApplicantWorkhour>(entity =>
            {
                ...
                entity.Property(e => e.IdApplicantWorkhour)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_applicant_workhour");
                ...
                entity.Property(e => e.FkIdWorkhour)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_id_workhour")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<Customer>(entity =>
            {
                ...
                entity.Property(e => e.HaveMoreWorkers)
                    .HasColumnName("have_more_workers")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<Disability>(entity =>
            {
                ...
                entity.Property(e => e.IdDisability)
                    .HasColumnType("int(11)")
                    .HasColumnName("id_disability");
            ...
            modelBuilder.Entity<DocumentFolder>(entity =>
            {
                ...
                entity.Property(e => e.IdDocumentFolder)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_document_folder");

                entity.Property(e => e.FkIdDocumentType)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_id_document_type")
                    .HasDefaultValueSql("'NULL'");

                entity.Property(e => e.FkIdPersonalFolder)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("FK_id_personal_folder")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<DocumentJob>(entity =>
            {
                ...
                entity.Property(e => e.IdDocumentJob)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_document_job");
            ...
            modelBuilder.Entity<JobExtraInfo>(entity =>
            {
                ...
                entity.Property(e => e.IdJobExtraInfo)
                    .HasColumnType("int(11)")
                    .HasColumnName("id_job_extra_info");
            ...
            modelBuilder.Entity<JobOffer>(entity =>
            {
                ...
                entity.Property(e => e.IdJobOffer)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_job_offer");

                entity.Property(e => e.ApplicantDisability)
                    .HasColumnName("applicant_disability")
                    .HasDefaultValueSql("'NULL'");

                entity.Property(e => e.ApplicantExperience)
                    .HasColumnName("applicant_experience")
                    .HasDefaultValueSql("'NULL'");

                entity.Property(e => e.ApplicantTattoosPiercings)
                    .HasColumnName("applicant_tattoos_piercings")
                    .HasDefaultValueSql("'NULL'");

                entity.Property(e => e.ApplicantsForHiring)
                    .HasColumnType("int(11)")
                    .HasColumnName("applicants_for_hiring")
                    .HasDefaultValueSql("'NULL'");
                ...
                entity.Property(e => e.FkIdCustomner)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("FK_id_customner")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<JobOfferBenefit>(entity =>
            {
                ...
                entity.Property(e => e.IdJobOfferBenefit)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_job_offer_benefit");

                entity.Property(e => e.FkIdBenefit)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_id_benefit")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<JobOfferExtraInfo>(entity =>
            {
                ...
                entity.Property(e => e.IdJobOfferExtraInfo)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_job_offer_extra_info");

                entity.Property(e => e.FkIdJobExtraInfo)
                    .HasColumnType("int(11)")
                    .HasColumnName("FK_id_job_extra_info")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<JobOfferWorkhour>(entity =>
            {
                ...
                entity.Property(e => e.IdJobOfferWorkhour)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_job_offer_workhour");
            ...
            modelBuilder.Entity<PersonalFolder>(entity =>
            {
                ...
                entity.Property(e => e.IdPersonalFolder)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_personal_folder");
            ...
            modelBuilder.Entity<PhysicalCondition>(entity =>
            {
                ...
                entity.Property(e => e.IdPhysicalCondition)
                    .HasColumnType("int(11)")
                    .HasColumnName("id_physical_condition");
            ...
            modelBuilder.Entity<WorkExperience>(entity =>
            {
                ...
                entity.Property(e => e.IdWorkExperience)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_work_experience");
            ...
            modelBuilder.Entity<WorkReference>(entity =>
            {
                ...
                entity.Property(e => e.IdWorkReference)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("id_work_reference");
                ...
                entity.Property(e => e.FkIdWorkExperience)
                    .HasColumnType("bigint(20)")
                    .HasColumnName("FK_id_work_experience")
                    .HasDefaultValueSql("'NULL'");
            ...
            modelBuilder.Entity<Workhour>(entity =>
            {
                ...
                entity.Property(e => e.IdWorkhour)
                    .HasColumnType("int(11)")
                    .HasColumnName("id_workhour");
